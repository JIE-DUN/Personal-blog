	...
	<div>
		...
		<div class="blog_keyWord">
			...
			<c:choose>
				...
				<c:otherwise>
					<form id="queryForm" action="${pageContext.request.contextPath}/blog/condition.html" method="post">
						<input type="hidden" id="condition1" name="condition"/>
